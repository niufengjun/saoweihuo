window.onload = function ()
{
    ...
    // 2  计算运费模式
            ...
            //新增运费模版输入框里的内容部分
            var liu_tiji=document.getElementById("liu_tiji");
            var liu_weight=document.getElementById("liu_weight");
            var liu_block=document.getElementById('liu_block');
            var liu_weight1=document.getElementById("liu_weight1");
            //选择体积计费时隐藏重量计费模块
            liu_tiji.onclick=function (){
                   liu_block.style.display="block";
                   liu_weight1.style.display="none";

            }
            //重量计费计费时隐藏体积计费模块
            liu_weight.onclick=function (){
                   liu_weight1.style.display="block";
                   liu_block.style.display="none";
    ...
    var heavy = document.getElementsByClassName("heavy");
    // console.log(heavy);

    var bulk = document.getElementsByClassName("bulk");
    // console.log(bulk);
    ...
    {   
      ...
      if (/\D/.test(heavy[i].value)||/\D/.test(bulk[i].value)) 
      {
        hint.style.display = "block";
        hint.innerHTML = "发货时间与计价方式请输入正整数";
      }

        heavy[i].onkeydown = function () 
        {
    ...
    var liu_tanbox= document.getElementById("liu_tanbox");

    var content_bg = document.getElementById("right_list");
  ...
  {   
    ...
    // 0  跳转
    // 0.1
     var t1=document.getElementsByName('text1')[0];
     var t2=document.getElementsByName('text2')[0];
     var t3=document.getElementsByName('text3')[0];
     var t4=document.getElementsByName('text4')[0];
     var t5=document.getElementsByName('text5')[0];
     var t6=document.getElementsByName('text6')[0];
     var t7=document.getElementsByName('text7')[0];
     var t8=document.getElementsByName('text8')[0];
     var t9=document.getElementsByName('text9')[0];
     var t10=document.getElementsByName('text10')[0];
     ...
     // 提示
       ...
       // 隐藏提示
       var inputs_s = document.getElementById("liu_warm").getElementsByTagName("input");
      // console.log(inputs_s);
       for (var i = 0; i < inputs_s.length; i++) 
       {
       	   inputs_s[i].onfocus = function () 
     	  {
    ...
    {
    //0.2 保存弹框
    liu_tanbox.style.display='block';
    var timer=setTimeout(function()
    {
        liu_tanbox.style.display='none';

        // 当前设置页面
        set_save.style.display="none";
    ...
    num.className = "num";
    num.innerHTML = box.children.length;
    sub_div.appendChild(num);
        
    // 3 内容标题
    var content = document.createElement("div");
    content.className = "title_content";
    ...
    // 4 修改 按钮
    var amend = document.createElement("div");
    amend.className = "amend";
    amend.innerHTML = "修改";
    sub_div.appendChild(amend);

    // 5 删除 按钮
    var delect = document.createElement("div");
    delect.className = "delect";
    delect.innerHTML = "删除";
    sub_div.appendChild(delect);
    ...
    {   
      ...
      // 输入框 获取 前提  名称 值
      input.value = this.parentNode.children[1].innerHTML;
      ...
      {  
          ...
          content_bg.style.display = "block";
           ...
           // 保存修改名称
         that.parentNode.children[1].innerHTML = input.value;
      }
    }

    // 7 删除 模板
    var Offlines = document.getElementsByClassName("delect");
    
    // 获取删除弹框
    var pop_up = document.getElementById("mask");
    ...
    sure.onclick = function () 
    {
      ...
      // 重新获取编号
      var sub_Ls = box.children;
      // console.log(sub_Ls);
      for (var i = 0; i < sub_Ls.length; i++) 
      {
        sub_Ls[i].children[0].innerHTML = i+1;
      } 
       ...
       if(sub_Ls.length == 0) 
        {
         content_bg_.style.display = "none";
         addition__.style.display = "block";
        }
    ...
    // 全部删除de情况
    var content_bg_ = document.getElementById("right_list");
    console.log(content_bg_);

    var addition__ = document.getElementById("addition");
    console.log(addition__);
    ...
    {   
      setTimeout(alert("添加成功  关闭弹框之后显示   已达上线,禁止再添加"),100);
    }
  ...
  var add_0 = document.getElementById("add");
  add_0.onclick = function () 
  {
    content_bg.style.display = "none";
    set_save.style.display = "block";
    // inputs[i].innerHTML = "";
...
　　addressInit('cmbProvince', 'cmbCity', 'cmbArea', '贵州', '贵阳市', '乌当区');
